...
app.post('/api/hire', async (req, res) => {
  ...
  if (isEmailConfigured()) {
    ...
    const ownerMailOptions = {
      ...
      to: process.env.TO_EMAIL || 'paved2307@gmail.com',
      replyTo: reply_to,
      subject: `💼 New Project Brief: "${project_title}" from ${from_name}`,
      html: `
        <div style="background-color: #0d0a08; padding: 40px 20px; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
          <div style="max-width: 600px; margin: 0 auto; background-color: #14110f; border: 1px solid #c9a84c; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
            ...
            <div style="background: linear-gradient(135deg, #1f1a16 0%, #0d0a08 100%); padding: 30px 24px; text-align: center; border-bottom: 1px solid #2d261e; position: relative;">
              <div style="font-size: 11px; text-transform: uppercase; letter-spacing: 3px; color: #c9a84c; font-weight: 700; margin-bottom: 8px;">New Project Inbound</div>
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  <td style="width: 50%; padding: 8px; vertical-align: top;">
                    <div style="font-size: 11px; text-transform: uppercase; color: #c9a84c; font-weight: bold; letter-spacing: 1px;">Project Type</div>
                    <div style="color: #f5f0e8; font-size: 15px; margin-top: 4px; font-weight: 600;">${project_type}</div>
                  </td>
                  <td style="width: 50%; padding: 8px; vertical-align: top;">
                    <div style="font-size: 11px; text-transform: uppercase; color: #c9a84c; font-weight: bold; letter-spacing: 1px;">Budget Range</div>
                    <div style="color: #f5f0e8; font-size: 15px; margin-top: 4px; font-weight: 600;">${budget}</div>
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; padding: 8px; vertical-align: top; padding-top: 16px;">
                    <div style="font-size: 11px; text-transform: uppercase; color: #c9a84c; font-weight: bold; letter-spacing: 1px;">Timeline</div>
            ...
            <div style="padding: 24px; color: #e5dec9; line-height: 1.7; font-size: 14px;">
              ...
              <p style="margin: 6px 0;"><strong>Company:</strong> ${company || 'Individual / None'}</p>
              ...
              <h3 style="color: #c9a84c; font-size: 14px; text-transform: uppercase; letter-spacing: 1.5px; margin-top: 24px; margin-bottom: 12px; border-bottom: 1px solid #2d261e; padding-bottom: 6px;">Project Scope</h3>
              ...
              <div style="text-align: center; margin-top: 32px; padding-top: 20px; border-top: 1px solid #2d261e;">
                ...
                <a href="mailto:${reply_to}?subject=Re: Project Inbound: ${encodeURIComponent(project_title)}" 
    ...
    const clientMailOptions = {
      ...
      to: reply_to,
      subject: `Your project brief has been received, ${from_name}!`,
      html: `
